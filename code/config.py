...
class Config:
    ...
    def change_theme(self):
        self.idx += 1
        self.idx %= len(self.themes) # a %= b means a = a % b #here used to reset idx of themes list so that it starts from 0 i.e. start of list
        self.theme = self.themes[self.idx]

    def _add_themes(self):
        green = Theme((234, 235, 200), (119, 154, 88), (244, 247, 167), (172, 195, 51), "#C86464", "#C84646")
